...
./build-archlinux  -v lily58:default:right:nice_nano -nrf52840
...
./uf2conv.py output/lily58/lily58-pca10056-nice_nano-default-right.hex -c -f 0xADA52840 -o ~/downloads/lily_blue_right.uf2
